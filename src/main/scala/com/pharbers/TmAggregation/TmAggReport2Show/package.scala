...
//        reportsColl.find(
//            $or(
//                $and(("phase" $lt phase), "proposalId" -> proposal._id.get.toString) ::
//                $and(("phase" $lt phase), "project" -> project._id.get.toString) :: Nil
//            )
//        ).toList
//
...
//        presetsColl.find(
//            $or(
//                $and(("phase" $lte phase), "proposalId" -> proposal._id.get.toString) ::
//                $and(("phase" $lte phase), "project" -> project._id.get.toString) :: Nil
//            )
//        ).toList
//
